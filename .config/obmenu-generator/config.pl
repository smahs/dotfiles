...
our $CONFIG = {
  ...
  "Linux::DesktopFiles" => {
                             ...
                             gtk_rc_filename         => "/home/smahs/.gtkrc-2.0",
                             icon_dirs_first         => undef,
                             icon_dirs_last          => undef,
                             icon_dirs_second        => undef,
                             keep_unknown_categories => 1,
                             skip_entry              => undef,
                             skip_filename_re        => qr/^(?:bssh|bvnc|avahi-discover|xterm|exo|qv4l2|xfce4|assistant-qt4|designer-qt4|linguist-qt4|qdbusviewer-qt4|jconsole|policytool)\b/,
                             skip_svg_icons          => 1,
